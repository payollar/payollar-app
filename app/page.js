...
import { ArrowRight, Stethoscope, CoinsIcon, Menu,  } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              Get instant access to vetted top talents, and a seamless management platform to book top talents for your entertainment projects
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Our platform makes Top talents accessible with just a few clicks
            </p>
          </div>
      ...
      <section id="pricing" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Choose the perfect consultation package that fits your Talents Booking
              needs
            </p>
          </div>
            ...
            <Card className="mt-12 bg-muted/20 border-emerald-900/30">
              <CardHeader>
                <CardTitle className="text-xl font-semibold text-white flex items-center">
                  <CoinsIcon className="h-5 w-5 mr-2 text-emerald-400" />
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Hear from Clients and Talents who use our platform
            </p>
          </div>
