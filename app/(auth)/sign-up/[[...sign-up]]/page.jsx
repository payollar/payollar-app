      ...
      await signUp.email(
        ...
        },
        {
          onSuccess: async () => {
            ...
            toast.info("Please check your email to verify your account. A verification link has been sent to your inbox.", {
              duration: 5000,
            });
            ...
            // Navigate to verification page first, then they can continue to onboarding
