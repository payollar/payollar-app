...
import "@uploadthing/react/styles.css"; // uploadthing styles
...
export default function OnboardingPage() {
  ...
  const onDoctorSubmit = async (data) => {
    ...
    console.log("Submitting form with image:", uploadedImageUrl);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            ...
            <CardDescription className="mb-4">
              Book appointments, consult with talent managers, and manage booking experience
            </CardDescription>
            <Button
        ...
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            ...
            <CardDescription className="mb-4">
              Create your professional profile, set your availability,and start getting bookings 
            </CardDescription>
            <Button
              className="w-full mt-2 bg-emerald-600 hover:bg-emerald-700"
              disabled={loading}
            ...
            <div className="space-y-2">
              ...
              {errors.skills && (
                <p className="text-sm font-medium text-red-500 mt-1">
                  ...
                  {/* ✅ Profile Image Upload (UploadThing) */}
      <div className="space-y-2">
        <Label>Profile Picture</Label>
        <UploadButton
          endpoint="profileImage" // must match router key in core.js
          onClientUploadComplete={(res) => {
            console.log("Upload complete:", res);
            setUploadedImageUrl(res[0].url); // save URL
          }}
          onUploadError={(err) => {
