...
import { Biohazard as Billboard, Search, MapPin, Eye, Star, Car, Calendar, ArrowRight } from "lucide-react"
...
export default function BillboardMediaPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <ProductsChannelTopBar title="Billboard Media" icon={Billboard} />

      {/* Header Cover */}
      <section className="relative h-64 md:h-80 w-full overflow-hidden">
        <img
          src={headerImage}
          alt="Billboard Media Cover"
      ...
      {registeredListings.length > 0 && (
        <section className="py-12 border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-bold mb-6">Registered Billboard Listings</h2>
              ...
              {registeredListings.map((listing) => (
                <Card key={listing.id} className="overflow-hidden">
                  <CardContent className="p-4">
                    ...
                    <Link href={`/media/schedule?type=BILLBOARD&listing=${listing.id}`}>
