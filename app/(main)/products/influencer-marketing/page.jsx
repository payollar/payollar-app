...
export default function InfluencerMarketingPage() {
  ...
  useEffect(() => {
    getActiveMediaListings("INFLUENCER_MARKETING").then((result) => {
      if (result.success && result.listings?.length) {
        setRegisteredListings(result.listings)
      }
    })
    getPublishedRateCards("INFLUENCER_MARKETING").then((result) => {
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      {rateCards.length > 0 && (
        <section className="py-12 border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-bold mb-6">Influencer Marketing Rate Cards</h2>
      ...
      {registeredListings.length > 0 && (
        <section className="py-12 border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-bold mb-6">Registered Influencer Listings</h2>
              ...
              {registeredListings.map((listing) => (
                <Card key={listing.id} className="overflow-hidden">
                  <CardContent className="p-4">
                    ...
                    <Link href={`/media/schedule?type=INFLUENCER_MARKETING&listing=${listing.id}`}>
