        ...
        <TabsList className="w-full justify-start overflow-x-auto">
          {days.map((day) => (
            ...
            >
              ...
              {day.slots.length > 0 && (
                <div className="ml-2 rounded-md bg-primary/15 px-2 py-1 text-xs font-medium text-primary">
                  {day.slots.length}
                </div>
              )}
            </TabsTrigger>
          ...
          <TabsContent key={day.date} value={day.date} className="pt-4">
            {day.slots.length === 0 ? (
              ...
              <div className="space-y-3">
                <h3 className="mb-2 text-lg font-medium text-foreground">{day.displayDate}</h3>
