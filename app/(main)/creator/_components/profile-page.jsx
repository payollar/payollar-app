        ...
        <TabsContent value="availability" className="space-y-6 mt-6">
          <Card className="border-emerald-900/20 bg-gray-900/50">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">
                Your current availability schedule. Manage your availability in the{" "}
                <Link href="/creator/services" className="text-emerald-400 hover:text-emerald-300">
                  Services
                </Link>{" "}
                section.
              </CardDescription>
            ...
            <CardContent>
              <div className="space-y-3">
                {Object.entries(dailyAvailability).map(([day, { available, time }]) => (
                  <div
                    key={day}
                    className="flex items-center justify-between p-4 rounded-lg bg-gray-800/50 border border-gray-700 hover:border-emerald-700/30 transition-colors"
                  >
