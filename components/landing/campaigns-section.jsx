      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative order-2 lg:order-1">
              ...
              <Card className="border-emerald-900/20 bg-slate-800/50 backdrop-blur-sm overflow-hidden group relative">
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h4 className="text-xl font-bold text-white mb-2">Tech Product Launch</h4>
                      <p className="text-sm text-gray-400">Digital Media Campaign</p>
                    </div>
            ...
            {/* Floating badge */}
            <div className="absolute -top-4 -left-4 bg-cyan-500/20 backdrop-blur-sm border border-cyan-500/30 rounded-full px-6 py-3">
              <div className="flex items-center gap-2">
                <Sparkles className="w-5 h-5 text-cyan-400" />
                <span className="text-white font-semibold">New Campaigns Daily</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 order-1 lg:order-2">
            <div className="space-y-4">
              <Badge className="px-4 py-2 bg-cyan-500/20 border-cyan-500/30 text-cyan-400">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-cyan-700/30 text-white hover:bg-cyan-900/30"
              >
                <Link href="/client">
