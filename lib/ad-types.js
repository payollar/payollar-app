...
export const TV_AD_TYPES = [
  ...
  },
  {
    id: "jingle",
    label: "Jingle",
    fullName: "Jingle / Sonic Branding",
    description: "Short musical or sonic brand IDs for TV breaks and idents. Highly memorable.",
    icon: "music",
  },
  {
    id: "announcement",
    label: "Announcement",
    fullName: "Station Announcement",
    description: "Station-read announcements, stingers, and live-read promotional spots.",
    icon: "megaphone",
  },
  {
    id: "interview",
  ...
  },
  {
    id: "billboard",
    label: "Billboard",
    fullName: "Billboard / Top & Tail",
    description: "Top-of-hour, tail, or strapline billboard placements during programming.",
